...
def samtools_mpileup(qclient, job_id, parameters, out_dir):
...
def samtools_mpileup_to_array(files, out_dir, params, prep_info, url, job_id):
    ...
    details_name = join(out_dir, 'samtools_mpileup.array-details')
