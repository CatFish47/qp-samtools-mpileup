...
setup(name='qp-samtools-mpileup',
      version=__version__,
      long_description=long_description,
      license="BSD",
      description='Qiita Plugin: qp-samtools-mpileup',
      author="Qiita development team",
      author_email="qiita.help@gmail.com",
      url='https://github.com/CatFish47/qp-samtools-mpileup',
      test_suite='nose.collector',
      packages=['qp_samtools_mpileup'],
      package_data={'qp_samtools_mpileup': [
